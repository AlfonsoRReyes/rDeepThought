...
>  Note. ‘F’ means to read / write the elements using `Fortran`-like index order, with the first index changing fastest, and the last index changing slowest. 

```{python}
import numpy as np
print np.reshape(np.arange(1, 25), (4, 3, 2), "F")   # "F"" means like-Fortran
```
