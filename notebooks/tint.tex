...
\section{Before We Get Started\ldots{}}\label{before-we-get-started}}

\begin{marginfigure}
\includegraphics{tint_files/figure-latex/fig-nocap-margin-first-1} \end{marginfigure}

\href{http://github.com/eddelbuettel/tint}{tint} is straightforward mix
of the (html and pdf parts of the) excellent
\href{https://github.com/rstudio/tufte}{tufte} package by JJ and Yihui,
mixed with the
\href{https://fonts.google.com/specimen/Roboto+Condensed}{Roboto
Condensed} font use and color scheme proposed by
\href{http://nogginfuel.com/envisioned-css/}{envisioned css} plus minor
style changes such as removal of \emph{italics}---but otherwise true to
the wonderful \href{https://github.com/rstudio/tufte}{tufte} package for
R---all baked together into a small package providing another template.

We support \emph{italic} aka \emph{em} and \textbf{strong} annotations
for text, as well as \texttt{code} snippets.

The package name is a standard package naming recursion: \emph{tint is
not tufte}.

The remainder of the \href{https://github.com/rstudio/tufte}{tufte}
skeleton document follows as is, with only marginal changes to refer to
this package for code.
...
\begin{marginfigure}
\includegraphics{tint_files/figure-latex/fig-margin-1} \caption[MPG vs horsepower, colored by transmission]{MPG vs horsepower, colored by transmission.}\label{fig:fig-margin}
\end{marginfigure}
...
\begin{figure*}
\includegraphics{tint_files/figure-latex/fig-fullwidth-1} \caption[A full width figure]{A full width figure.}\label{fig:fig-fullwidth}
\end{figure*}
...
\begin{figure}
\includegraphics{tint_files/figure-latex/fig-main-1} \caption[A figure in the main column]{A figure in the main column.}\label{fig:fig-main}
\end{figure}
...
\begin{figure}
\includegraphics{tint_files/figure-latex/fig-two-together-1} \includegraphics{tint_files/figure-latex/fig-two-together-2} \caption[Two plots in one figure environment]{Two plots in one figure environment.}\label{fig:fig-two-together}
\end{figure}
...
\begin{figure}
\includegraphics{tint_files/figure-latex/fig-two-separate-1} \caption[Two plots in separate figure environments (the first plot)]{Two plots in separate figure environments (the first plot).}\label{fig:fig-two-separate1}
\end{figure}
...
\begin{figure}
\includegraphics{tint_files/figure-latex/fig-two-separate-2} \caption[Two plots in separate figure environments (the second plot)]{Two plots in separate figure environments (the second plot).}\label{fig:fig-two-separate2}
\end{figure}
...
\begin{marginfigure}
\includegraphics{tint_files/figure-latex/fig-margin-together-1} \includegraphics{tint_files/figure-latex/fig-margin-together-2} \caption[Two plots in one figure environment in the margin]{Two plots in one figure environment in the margin.}\label{fig:fig-margin-together}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{tint_files/figure-latex/fig-margin-separate-1} \caption[Two plots in separate figure environments in the margin (the first plot)]{Two plots in separate figure environments in the margin (the first plot).}\label{fig:fig-margin-separate1}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{tint_files/figure-latex/fig-margin-separate-2} \caption[Two plots in separate figure environments in the margin (the second plot)]{Two plots in separate figure environments in the margin (the second plot).}\label{fig:fig-margin-separate2}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{tint_files/figure-latex/fig-nocap-margin-1} \end{marginfigure}
...
\includegraphics{tint_files/figure-latex/fig-nocap-main-1}
...
\begin{figure*}
\includegraphics{tint_files/figure-latex/fig-nocap-fullwidth-1} \end{figure*}
...
\href{https://github.com/eddelbuettel/tint/blob/master/inst/rmarkdown/templates/pdf/skeleton/skeleton.Rmd}{this
...
\NormalTok{  tint}\OperatorTok{:::}\KeywordTok{template_resources}\NormalTok{(}
    \StringTok{'tint'}\NormalTok{, }\StringTok{'..'}\NormalTok{, }\StringTok{'skeleton'}\NormalTok{, }\StringTok{'skeleton.Rmd'}
\NormalTok{  )}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
